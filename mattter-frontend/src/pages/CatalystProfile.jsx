            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-dark-surface border border-dark-border rounded-3xl p-8">
                            <div className="flex items-start justify-between mb-6">
                                ...
                                {catalyst.is_active ? (
                                    ...
                                    <div className="flex items-center gap-2 px-4 py-2 bg-gray-500/20 text-gray-400 rounded-full">
                            ...
                            {catalyst.bio && (
                                <div className="mb-6">
                                    ...
                                    <p className="text-text-secondary leading-relaxed">{catalyst.bio}</p>
                                </div>
                            )}
                            ...
                            {catalyst.specializations && catalyst.specializations.length > 0 && (
                                <div>
                                    <h3 className="text-lg font-semibold text-text-primary mb-3">Expertise</h3>
                                    <div className="flex flex-wrap gap-2">
                                        {catalyst.specializations.map((spec, idx) => (
                                            <span
                                                key={idx}
                                                className="px-4 py-2 bg-gradient-to-r from-accent-purple/20 to-accent-pink/20 border border-accent-purple/30 text-accent-purple rounded-xl font-medium"
                                            >
                                                {spec}
                                            </span>
                                        ))}
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-dark-surface border border-dark-border rounded-3xl p-6 sticky top-4">
                            {/* Service Fee */}
                            ...
                            <div className="space-y-4">
                                <h3 className="text-lg font-semibold text-text-primary">Send Booking Request</h3>
